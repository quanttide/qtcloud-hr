locals {
  ...
  lark_cli_credentials_oss_endpoint_value = trimsuffix(trimspace(var.lark_cli_credentials_oss_endpoint), "/")
  lark_cli_credentials_mount_endpoint     = startswith(lower(local.lark_cli_credentials_oss_endpoint_value), "https://") ? local.lark_cli_credentials_oss_endpoint_value : "https://${local.lark_cli_credentials_oss_endpoint_value}"
}
